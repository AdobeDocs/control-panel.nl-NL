...
* **Binnenkomende gegevens** decoderen: Adobe Campaign ontvangt gegevens die van een extern systeem zijn versleuteld met een openbare sleutel die u hebt gedownload van het Configuratiescherm. Adobe Campagne ontsleutelt de gegevens met een persoonlijke sleutel die is gegenereerd vanuit het Configuratiescherm.

## Gegevens versleutelen {#encrypting-data}

Met het Configuratiescherm kunt u gegevens coderen die afkomstig zijn van uw Adobe Campagne-instantie.
...
1. Genereer een combinatie van openbare en persoonlijke sleutels met een GPG-coderingsprogramma volgens de [OpenPGP-specificatie](https://www.openpgp.org/about/standard/). Hiertoe installeert u een GPG-hulpprogramma of GNuGP-software.
...
1. Geef bij de aanwijzing de gewenste parameters voor de toets op. De vereiste parameters zijn:
   ...
   * **opmerking**: Door een label toe te voegen aan het opmerkingenveld kunt u de sleutel gemakkelijk identificeren in de lijst met toetsen in het Configuratiescherm.
   * **vervaldatum**: Datum of &quot;0&quot; voor geen vervaldatum.
   * **passphrase**
   ![](assets/do-not-localize/gpg_command.png)

1. Nadat dit is bevestigd, genereert het script een sleutel die u naar een bestand kunt exporteren of rechtstreeks in het regelpaneel kunt plakken. Als u het bestand wilt exporteren, voert u deze opdracht uit, gevolgd door de vingerafdruk van de sleutel die u hebt gegenereerd.
...
1. Plak de openbare sleutel die is gegenereerd met het PGP-versleutelingsgereedschap. U kunt het bestand met de openbare sleutel ook rechtstreeks slepen en neerzetten.
...
De sleutel is dan beschikbaar voor gebruik in de werkschema&#39;s van de Campagne van Adobe. U kunt het gebruiken om gegevens te coderen wanneer het gebruiken van de activiteiten van de gegevensextractie.

Raadpleeg de documentatie bij Adobe Campagne voor meer informatie hierover:
...
* [Activiteit voor gegevensextractie (bestand)](https://docs.adobe.com/content/help/en/campaign-classic/using/automating-with-workflows/action-activities/extraction--file-.html)

**Campagnestandaard:**

* [Gecodeerde gegevens beheren](https://docs.adobe.com/content/help/en/campaign-standard/using/managing-processes-and-data/workflow-general-operation/importing-data.html#managing-encrypted-data)
* [Bestandsactiviteit extraheren](https://docs.adobe.com/content/help/en/campaign-standard/using/managing-processes-and-data/data-management-activities/extract-file.html)

## Gegevens decoderen {#decrypting-data}

Met het Configuratiescherm kunt u externe gegevens die in uw Adobe Campagne-instanties komen, decoderen.
...
1. Open de **[!UICONTROL Instance settings]** kaart en selecteer vervolgens het **[!UICONTROL GPG keys]** tabblad en de gewenste instantie van Adobe Campagne.
...
* [Activiteit bij laden van gegevens (bestand)](https://docs.adobe.com/content/help/en/campaign-classic/using/automating-with-workflows/action-activities/data-loading--file-.html)

**Campagnestandaard:**

* [Gecodeerde gegevens beheren](https://docs.adobe.com/content/help/en/campaign-standard/using/managing-processes-and-data/workflow-general-operation/importing-data.html#managing-encrypted-data)
* [Bestandsactiviteit laden](https://docs.adobe.com/content/help/en/campaign-standard/using/managing-processes-and-data/data-management-activities/load-file.html)
...
>[!IMPORTANT]
>
>Voordat u een sleutel verwijdert, moet u ervoor zorgen dat deze niet wordt gebruikt in een Adobe Campagne-workflow om te voorkomen dat deze mislukt.
