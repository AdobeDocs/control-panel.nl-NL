...
Als u bent aangemeld voor [e-mailwaarschuwingen](../../performance-monitoring/using/email-alerting.md), ontvangt u meldingen per e-mail wanneer een van uw SFTP-servers 80% of meer van zijn capaciteit heeft bereikt. Zie [SFTP-opslagbeheer](../../sftp/using/sftp-storage-management.md).
