...
# IP-bereiken toevoegen aan de lijst van gewenste IP-adressen {#ip-range-whitelisting}
...
## IP-adressen toevoegen aan de lijst van gewenste IP-adressen {#whitelisting-ip-addresses}
